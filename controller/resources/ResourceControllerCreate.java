...
public class ResourceControllerCreate extends HttpServlet {
				...
				if( rSearch.isEmpty()){
					...
					if(aSearch.isEmpty()){
						...
						if(request.getParameter("action").equals("creating")){
							RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/Resources/resourceCreate.jsp");
